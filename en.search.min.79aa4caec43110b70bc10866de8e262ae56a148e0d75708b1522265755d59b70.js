...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/db-learn/flexsearch.min.js');loadScript('/db-learn/en.search-data.min.d7c0880139151559d97461cb84a10fe432be239ad6b381ba11d55af81c1e1d05.js',function(){input.required=false;search();});}
