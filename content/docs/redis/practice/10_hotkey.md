...
对于数据不一致的问题，其实只要保证**最终一致性**即可。**缩短本地缓存的过期时间**，根据业务能够接受不一致的时间来设置，比如 10s 或者更短的过期时间。
...
![hotkey-window](https://raw.gitcode.com/shipengqi/illustrations/files/main/db/hotkey-window.png)
...
![hotkey-arch](https://raw.gitcode.com/shipengqi/illustrations/files/main/db/hotkey-arch.png)
...
![hotkey-arch2](https://raw.gitcode.com/shipengqi/illustrations/files/main/db/hotkey-arch2.png)
