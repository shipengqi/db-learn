...
![user-records-in-page](../../imgs/user-records-in-page.jpg)

### 记录头信息
以 `compact` 格式为例：
![compact-record-head-sample](../../imgs/compact-record-head-sample.jpg)
...
![compact-record-insert-sample](../../imgs/compact-record-insert-sample.jpg)
...
![fake-record-struct](../../imgs/fake-record-struct.jpg)
...
![next-recard-sample](../../imgs/next-recard-sample.jpg)

记录按照主键从小到大的顺序形成了一个**单链表**。最大记录的 `next_record` 的值为 0。

如果删掉第 2 条记录：

![next-recard-sample](../../imgs/next-recard-sample2.jpg)
...
![](../../imgs/page-directory-sample.jpg)
...
![](../../imgs/page-directory-sample2.jpg)
